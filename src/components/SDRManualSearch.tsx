...
export default function SDRManualSearch() {
  ...
  return (
    <main id="top" className="-mt-[72px] min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto grid max-w-content gap-6 px-4 py-8 md:grid-cols-[280px_1fr] md:px-8">
