...
export function PageShell({ title, description, children }: { title: string; description: string; children: React.ReactNode }) {
  return (
    <main className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-white pt-28">
      <section className="px-6 py-12 md:px-16 lg:px-28">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="overflow-hidden rounded-[2rem] border border-orange-100 bg-gradient-to-br from-white via-orange-50 to-amber-100 p-8 text-slate-950 shadow-2xl shadow-orange-100/70 md:p-12">
