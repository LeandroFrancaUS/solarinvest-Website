...
export function PageShell({ title, description, children }: { title: string; description: string; children: React.ReactNode }) {
  return (
    <main className="min-h-screen min-h-[100dvh] overflow-x-clip bg-gradient-to-b from-orange-50 via-white to-white pt-8 sm:pt-12">
      <section className="pb-12">
        <div className={clientAreaContainerClass}>
          <div className="min-w-0 overflow-hidden rounded-3xl border border-orange-100 bg-gradient-to-br from-white via-orange-50 to-amber-50 p-4 text-slate-900 shadow-xl shadow-orange-100/60 sm:p-6 md:p-8">
